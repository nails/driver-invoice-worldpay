...
class Data
{
     ...
     */
    public static function buildFromDataArray(array $aData): self
    {
        ...
        return new self(
            $oInvoiceModel->getById($aData['invoice_id']),
            $oCurrencyService->getByIsoCode($aData['currency_code']),
            $aData['amount'],
            $oSourceModel->getById($aData['source_id']),
            $oPaymentModel->getById($aData['payment_id']),
            Factory::resource('InvoiceDataPayment', Constants::MODULE_SLUG, $aData['payment_data']),
            $aData['customer_present'],
        );
    }
